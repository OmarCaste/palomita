...
public class UpdateMovie extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        movie.update(Integer.parseInt(txtId.getText()),txtName.getText(), txtSynopsis.getText(), txtDuration.getText(), txtGenre.getText(), txtActor.getText(), txtClassification.getText());
        this.dispose();
